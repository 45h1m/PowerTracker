...
const { addData, getISTDateTime, sendDates, sendData } = require("./controllers/dbController");


const credentials = {
    key: fs.readFileSync('./powertracker-production.up.railway.app+4-key.pem', 'utf-8'),
    cert: fs.readFileSync("./powertracker-production.up.railway.app+4.pem", "utf-8")
};
